...
#         root_dir = os.path.dirname(root_dir)
        ...
        self.icd_hierarchy = join(self.project_dir, 'utils/ontologies/codes_2L.json')
        ...
        parser.add_argument('--pos_encoding', type=str, default=None, help='None, embedding, or encoding')
        ...
        parser.add_argument('--direction', type=str, default='diag', help='None or Bi-Direction')
